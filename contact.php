<?php 
	...
	#Your e-mail address
	define("__TO__", "euricotecnologia@gmail.com");

	#Message subject
	define("__SUBJECT__", "euricotecnologia@gmail.com = From:");
	...
	if(isset($_POST['name']) and isset($_POST['mail']) and isset($_POST['comment'])){
		...
		if($name == '') {
			...
			echo json_encode(array('info' => 'error', 'msg' => "Digite um email válido."));
			exit();
		} else if($comment == ''){
			echo json_encode(array('info' => 'error', 'msg' => "Digite a mensagem."));
			exit();
		} else {
			//Send Mail
			$to = __TO__;
